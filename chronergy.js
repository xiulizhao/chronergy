(function (root, factory) {
  ...
  function showTime($ele) {
    ...
    var cycle = arr[nowtime.getDay()];
    var year = nowtime.getFullYear();
    var month = nowtime.getMonth() + 1;
    var date = nowtime.getDate();
    var specific_date = year + "年" + month + "月" + date + "日";
    $.wwclass.helper.updateProp($ele, "data-x-spdata", specific_date);
    var spweek = cycle;
    $.wwclass.helper.updateProp($ele, "data-x-spweek", spweek);
    var sptime = nowtime.toLocaleTimeString('chinese', { hour12: false });
    $.wwclass.helper.updateProp($ele, "data-x-sptime", sptime);
  ...
  function processElement($ele) {
    ...
    setTimeout(function () {
      $.wwclass.helper.updateProp($ele, "data-x-inited", true);
      $ele.find(".chronergy").removeClass("hidden");
    }, 100);
